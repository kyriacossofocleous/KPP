...
int InitSaveData()
{
  fpDat = fopen("small_sp.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : small_sp.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("small_sp_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : small_sp_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("small_sp_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: small_sp_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("small_sp.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : small_sp.m");
    exit(1);
  }

  fprintf(fpMatlab, "load small_sp.dat;\n");
  fprintf(fpMatlab, "%sc = small_sp;\n", prefix);
  fprintf(fpMatlab, "clear small_sp;\n");
