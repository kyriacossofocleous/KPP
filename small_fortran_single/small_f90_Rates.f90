...
!~~~>  Arrhenius
   REAL(kind=sp) FUNCTION ARR( A0,B0,C0 )
      REAL A0,B0,C0      
...
!~~~> Note: The argument B0 has a changed sign when compared to ARR
   ...
   REAL(kind=sp) FUNCTION EP2(A0,C0,A2,C2,A3,C3)
   ...
   REAL(kind=sp) FUNCTION EP3(A1,C1,A2,C2) 
      REAL A1, C1, A2, C2
      REAL(kind=dp) K1, K2      
   ...
   REAL(kind=sp) FUNCTION FALL ( A0,B0,C0,A1,B1,C1,CF)
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  SUBROUTINE Update_SUN()
    ...
    REAL(kind=sp) :: SunRise, SunSet
    REAL(kind=sp) :: Thour, Tlocal, Ttmp 
    ! PI - Value of pi
    REAL(kind=sp), PARAMETER :: PI = 3.14159265358979d0
