...
int InitSaveData()
{
  fpDat = fopen("saprc_mp.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : saprc_mp.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("saprc_mp_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : saprc_mp_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("saprc_mp_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: saprc_mp_E.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveK()
{
  fpK = fopen("saprc_mp_K.dat","w");
  if ( fpK == 0 ){
    printf("\n Can't create file: saprc_mp_K.dat");
    exit(1);
  }
  return 0;
}

int SaveK(float A, float Vdot1, float Vdot2, float Vdot3)
{
  fprintf( fpK, "%6.3f ", TIME/3600.0);
  fprintf( fpK, "%e ", A);
  fprintf( fpK, "%e ", Vdot1);
  fprintf( fpK, "%e ", Vdot2);
  fprintf( fpK, "%e ", Vdot3);
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("saprc_mp.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : saprc_mp.m");
    exit(1);
  }

  fprintf(fpMatlab, "load saprc_mp.dat;\n");
  fprintf(fpMatlab, "%sc = saprc_mp;\n", prefix);
  fprintf(fpMatlab, "clear saprc_mp;\n");
