...
int InitSaveData()
{
  fpDat = fopen("chapman_enh.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : chapman_enh.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("chapman_enh_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : chapman_enh_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("chapman_enh_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: chapman_enh_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("chapman_enh.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : chapman_enh.m");
    exit(1);
  }

  fprintf(fpMatlab, "load chapman_enh.dat;\n");
  fprintf(fpMatlab, "%sc = chapman_enh;\n", prefix);
  fprintf(fpMatlab, "clear chapman_enh;\n");
