...
C ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      DATA SPC_NAMES /
     *'SO4','ACTA','R3N2','SUCA','GLUA',
     *'ADIA','PRN2','PRPN','OZID','MSA',
     *'DOL6','DOL7','DOL8','CPET','CHEX',
     *'MACA','PYVA','DMS','C2H6','C3H8',
     *'MPAN','IPAN','H2O2','AROM','TPAN',
     *'N2O5','HONO','RAN2','CH4','ALKA',
     *'HNO4','PAN','ACO2','DIAL','GLYX',
     *'CRES','AHO2','RAN1','ZO2','ETHE',
     *'CO','MGLY','MAN2','TO2','HAC',
     *'R3O2','EO2','PO2','MRO2','MVN2',
     *'ETO2','PRN1','RIO2','TCO3','INO2',
     *'HACO','HNO3','MGGY','VRO2','ALKE',
     *'RAO2','KET','KO2','ISOP','MO2',
     *'MAO3','CRO2','MCRG','MVKO','MAOO',
     *'ROOH','MCO3','MACR','O3','MVK',
     *'NO2','HCHO','SO2','ALD2','CHO2',
     *'NO','HO2','NO3','OH','O2',
     *'H2O','CO2','H2' / 
     ...
     *'       C3H8 + OH --> R3O2                       ',
     *'  R3O2 + NO --> 0.03 R3N2 + 0.49 KET + 0.97 NO2 + 0.46',
     *'       ALKA + OH --> RAO2                       ',
     *'  RAO2 + NO --> 0.263 RAN2 + 0.1057 R3O2 + 0.1879 ETO2',
     *'      ALKA + NO3 --> HNO3 + RAO2                ',
     *'       RAN2 + OH --> RAN1 + H2O                 ',
     *'  RAN1 + NO --> 2.5 NO2 + 0.8 HCHO + 2.1 ALD2 - -0.5 N',
     ...
     *'      MCO3 + HO2 --> ROOH + O2                  ',
     *'        KET + OH --> KO2                        ',
     *'   KO2 + NO --> 0.05 RAN2 + 0.94 MCO3 + 0.95 NO2 + 0.9',
     *'             KET --> ETO2 + MCO3 + H2O          ',
     *'       KET + NO3 --> HNO3 + KO2                 ',
     ...
     *'  ETHE + O3 --> 0.06 CH4 + 0.42 CO + HCHO + 0.4 CHO2 +',
     *'  ALKE + O3 --> 0.215 MO2 + 0.2 CRO2 + 0.525 HCHO + 0.',
     *'       CHO2 + NO --> NO2 + HCHO                 ',
     *'      NO2 + CHO2 --> HCHO + NO3                 ',
     *'      CHO2 + H2O --> ACO2                       ',
     *'       CRO2 + NO --> NO2 + ALD2                 ',
     ...
     *'   TO2 + NO --> DIAL + 0.18 GLYX + 0.72 MGLY + NO2 + H',
     *'            GLYX -->                            ',
     *'       GLYX + OH --> 2 CO + HO2 + H2O           ',
     *'            MGLY --> CO + MCO3 + HO2            ',
     *'       MGLY + OH --> CO + MCO3 + H2O            ',
     *'  CRES + OH --> 0.9 ZO2 + 0.9 TCO3 - -0.0315 NO2 + 0.8',
     *'      CRES + NO3 --> HNO3                       ',
     *'       DIAL + OH --> TCO3                       ',
     *'      TCO3 + NO2 --> TPAN                       ',
     *'            TPAN --> TCO3 + NO2                 ',
     *'  TCO3 + NO --> 0.89 GLYX + 0.11 MGLY + 0.05 MCO3 + NO',
     *'        ZO2 + NO --> NO2                        ',
     ...
     *'            AHO2 --> HCHO + HO2                 ',
     *'       ISOP + OH --> RIO2                       ',
     *'  RIO2 + NO --> 0.45 MACR + 0.45 MVK + 0.9 NO2 + 0.9 H',
     *'      RIO2 + HO2 --> ROOH                       ',
     *'        MVK + OH --> VRO2                       ',
     *'  VRO2 + NO --> 0.6 HAC + 0.3 MGGY + 0.6 MCO3 + 0.9 NO',
     *'      VRO2 + HO2 --> ROOH                       ',
     *'       MACR + OH --> MAO3                       ' / 
     ...
     *'      MAO3 + HO2 --> ROOH                       ',
     *'       MACR + OH --> MRO2                       ',
     *'  MRO2 + NO --> 0.9 MGGY + 0.9 NO2 + 0.9 HCHO + 0.9 HO',
     *'      MRO2 + HO2 --> ROOH                       ',
     *'        HAC + OH --> HACO                       ',
     *'      HACO + NO2 --> IPAN                       ',
     *'            IPAN --> HACO + NO2                 ',
     ...
     *'      HACO + HO2 --> ROOH                       ',
     *'  ISOP + O3 --> 0.2 MVKO + 0.3 MAOO + 0.3 MACR + 0.2 M',
     *'   O3 + MVK --> 0.5 MGGY + 0.2 MCRG + 0.15 MCO3 + 0.5 ',
     *'  MACR + O3 --> 0.5 MGGY + 0.2 MCRG + 0.15 NO2 + 0.65 ',
     *'       MVKO + NO --> MVK + NO2                  ',
     *'      MVKO + NO2 --> MVK + NO3                  ',
     *'      MVKO + H2O -->                            ',
     *'       MAOO + NO --> MACR + NO2                 ',
     ...
     *'      INO2 + HO2 -->                            ',
     *'       MVK + NO3 --> MVN2                       ',
     *'  MVN2 + NO --> 0.5 MGGY + 0.5 MCO3 + 2 NO2 + HCHO + 0',
     *'      MVN2 + HO2 -->                            ',
     *'      MACR + NO3 --> HNO3 + MAO3                ',
     *'      MACR + NO3 --> MAN2                       ',
