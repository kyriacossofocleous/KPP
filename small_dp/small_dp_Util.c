...
int InitSaveData()
{
  fpDat = fopen("small_dp.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : small_dp.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("small_dp_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : small_dp_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("small_dp_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: small_dp_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("small_dp.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : small_dp.m");
    exit(1);
  }

  fprintf(fpMatlab, "load small_dp.dat;\n");
  fprintf(fpMatlab, "%sc = small_dp;\n", prefix);
  fprintf(fpMatlab, "clear small_dp;\n");
