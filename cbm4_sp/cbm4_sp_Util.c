...
int InitSaveData()
{
  fpDat = fopen("cbm4_sp.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : cbm4_sp.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("cbm4_sp_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : cbm4_sp_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("cbm4_sp_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: cbm4_sp_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("cbm4_sp.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : cbm4_sp.m");
    exit(1);
  }

  fprintf(fpMatlab, "load cbm4_sp.dat;\n");
  fprintf(fpMatlab, "%sc = cbm4_sp;\n", prefix);
  fprintf(fpMatlab, "clear cbm4_sp;\n");
