...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
   float Ynew[32], Fcn0[32], Fcn[32],
       dFdT[32],
       Jac0[300], Ghimj[300];
   float K[32 * ros_S];
   float H, T, Hnew, HC, HG, Fac, Tau;
   float Err, Yerr[32];
   int Pivot[32], Direction, ioffset, j, istage;
      ...
      *Hexit = H;
      ...
      { /* WHILE STEP NOT ACCEPTED */
         ...
         for (istage = 1; istage <= ros_S; istage++)
         {
            ...
            /* Current istage offset. Current istage vector is K[ioffset:ioffset+32-1] */
            ioffset = 32 * (istage - 1);

            /* For the 1st istage the function has been computed previously */
            if (istage == 1)
               WCOPY(32, Fcn0, 1, Fcn, 1);
            else
            { /* istage>1 and a new function evaluation is needed at current istage */
               if (ros_NewF[istage - 1])
               {
                  ...
                  for (j = 1; j <= istage - 1; j++)
                     WAXPY(32, ros_A[(istage - 1) * (istage - 2) / 2 + j - 1],
                           &K[32 * (j - 1)], 1, Ynew, 1);
         ...
         WCOPY(32, Y, 1, Ynew, 1);
         for (j = 1; j <= ros_S; j++)
            WAXPY(32, ros_M[j - 1], &K[32 * (j - 1)], 1, Ynew, 1);

         /*~~~>  Compute the error estimation   */
         WSCAL(32, ZERO, Yerr, 1);
         for (j = 1; j <= ros_S; j++)
            WAXPY(32, ros_E[j - 1], &K[32 * (j - 1)], 1, Yerr, 1);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
   ...
   WAXPY(32, (-ONE), Fcn0, 1, dFdT, 1);
   WSCAL(32, (ONE / (float)Delta), dFdT, 1);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
   ...
   { /* while Singular */
      ...
      WCOPY(300, Jac0, 1, Ghimj, 1);
      WSCAL(300, (-ONE), Ghimj, 1);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
   ...
   /*~~~> Note: for a full matrix use Lapack:
      NRHS = 1
      DGETRS( 'N', 32 , NRHS, A, 32, Pivot, b, 32, INFO ) */
