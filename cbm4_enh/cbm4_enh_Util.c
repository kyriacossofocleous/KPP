...
int InitSaveData()
{
  fpDat = fopen("cbm4_enh.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : cbm4_enh.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("cbm4_enh_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : cbm4_enh_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("cbm4_enh_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: cbm4_enh_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("cbm4_enh.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : cbm4_enh.m");
    exit(1);
  }

  fprintf(fpMatlab, "load cbm4_enh.dat;\n");
  fprintf(fpMatlab, "%sc = cbm4_enh;\n", prefix);
  fprintf(fpMatlab, "clear cbm4_enh;\n");
