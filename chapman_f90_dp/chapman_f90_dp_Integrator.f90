...
! 
! File                 : chapman_f90_dp_Integrator.f90
...
MODULE chapman_f90_dp_Integrator

  USE chapman_f90_dp_Parameters, ONLY: NVAR, NFIX, NSPEC, LU_NONZERO
...
!~~~> Input arguments
   REAL(kind=dp), INTENT(IN) :: T 
   REAL(kind=dp), INTENT(IN) :: Roundoff, Y(N), Fcn0(N)
!~~~> Output arguments
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE chapman_f90_dp_Parameters, ONLY: NVAR, LU_NONZERO
 USE chapman_f90_dp_Global, ONLY: FIX, RCONST, TIME
 USE chapman_f90_dp_Function, ONLY: Fun
 USE chapman_f90_dp_Rates, ONLY: Update_SUN, Update_RCONST
!~~~> Input variables
   REAL(kind=dp) :: Y(NVAR)
   REAL(kind=dp) :: T
!~~~> Output variables
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE chapman_f90_dp_Parameters, ONLY: NVAR, LU_NONZERO
 USE chapman_f90_dp_Global, ONLY: FIX, RCONST, TIME
 USE chapman_f90_dp_Jacobian, ONLY: Jac_SP, LU_IROW, LU_ICOL
 USE chapman_f90_dp_LinearAlgebra
 USE chapman_f90_dp_Rates, ONLY: Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T
...
END MODULE chapman_f90_dp_Integrator
