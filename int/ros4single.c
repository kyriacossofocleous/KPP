...
int Nfun, Njac, Nstp, Nacc, Nrej, Ndec, Nsol, Nsng, Ncss;
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
   ...
   static int Ns = 0, Na = 0, Nr = 0, Ng = 0, Nc = 0;
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  *~~~>     OUTPUT PARAMETERS:
    ...
    IPAR[18] = No. of cases where step is accepted but error is such that next time step is reduced
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
   ...
   for (i = 0; i < KPP_NVAR; i++)
   {
      ...
      E[i] = (Yerr[i] * Yerr[i]) / (Scale * Scale);
      Err = Err + E[i];
   } /* for i */
   Err = SQRTF(Err / (KPP_REAL)KPP_NVAR);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
   ...
   { /* while Singular */
      ...
      { /* ising .ne. 0 */
         ...
         if (Nconsecutive <= 5)
         { /* Less than 5 consecutive failed LUs */
            *H = (*H) * HALF;
         }
         else
         {            /* More than 5 consecutive failed LUs */
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
   KPP_REAL g = 1.70710678118655; /* 1.0 + 1.0/SQRT(2.0) */
