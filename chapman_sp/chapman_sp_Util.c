...
int InitSaveData()
{
  fpDat = fopen("chapman_sp.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : chapman_sp.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("chapman_sp_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : chapman_sp_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("chapman_sp_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: chapman_sp_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("chapman_sp.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : chapman_sp.m");
    exit(1);
  }

  fprintf(fpMatlab, "load chapman_sp.dat;\n");
  fprintf(fpMatlab, "%sc = chapman_sp;\n", prefix);
  fprintf(fpMatlab, "clear chapman_sp;\n");
