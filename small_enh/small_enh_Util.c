...
int InitSaveData()
{
  fpDat = fopen("small_enh.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : small_enh.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("small_enh_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : small_enh_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("small_enh_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: small_enh_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("small_enh.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : small_enh.m");
    exit(1);
  }

  fprintf(fpMatlab, "load small_enh.dat;\n");
  fprintf(fpMatlab, "%sc = small_enh;\n", prefix);
  fprintf(fpMatlab, "clear small_enh;\n");
