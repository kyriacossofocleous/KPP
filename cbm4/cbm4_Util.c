...
int InitSaveData()
{
  fpDat = fopen("cbm4.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : cbm4.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("cbm4_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : cbm4_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("cbm4_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: cbm4_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("cbm4.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : cbm4.m");
    exit(1);
  }

  fprintf(fpMatlab, "load cbm4.dat;\n");
  fprintf(fpMatlab, "%sc = cbm4;\n", prefix);
  fprintf(fpMatlab, "clear cbm4;\n");
