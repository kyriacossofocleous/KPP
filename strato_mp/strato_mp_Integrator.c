...
void JacTemplate(double, float[], float[]);
int Rosenbrock(float Y[], double Tstart, double Tend,
               float AbsTol[], float RelTol[],
               void (*ode_Fun)(double, float[], float[]),
               void (*ode_Jac)(double, float[], float[]),
               // void (*ode_Fun2)(double, float[], float[]),
               float RPAR[], int IPAR[]);
int RosenbrockIntegrator(
    float Y[], double Tstart, double Tend,
    float AbsTol[], float RelTol[],
    void (*ode_Fun)(double, float[], float[]),
    void (*ode_Jac)(double, float[], float[]),
   //  void (*ode_Fun2)(double, float[], float[]),
...
void JacTemplate(double T, float Y[], float Ydot[]);
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
void JacTemplate(double T, float Y[], float Jcb[])
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   
...
} /* JacTemplate   *//* End of INTEGRATE function                                        */
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
