...
C                                                                  
C File                 : chapman_ref_Stoichiom.f                   
...
C JVRP(1) = dARP(2)/dV(1)                                          
      JVRP(1) = F(1)
C JVRP(2) = dARP(3)/dV(2)                                          
      JVRP(2) = 1
C JVRP(3) = dARP(4)/dV(1)                                          
      JVRP(3) = V(2)
C JVRP(4) = dARP(4)/dV(2)                                          
      JVRP(4) = V(1)
C JVRP(5) = dARP(5)/dV(2)                                          
      JVRP(5) = V(3)
C JVRP(6) = dARP(5)/dV(3)                                          
      JVRP(6) = V(2)
C JVRP(7) = dARP(6)/dV(1)                                          
      JVRP(7) = V(4)
C JVRP(8) = dARP(6)/dV(4)                                          
      JVRP(8) = V(1)
C JVRP(9) = dARP(7)/dV(4)                                          
      JVRP(9) = 1
      RETURN
      END
