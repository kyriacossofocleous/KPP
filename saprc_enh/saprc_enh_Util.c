...
int InitSaveData()
{
  fpDat = fopen("saprc_enh.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : saprc_enh.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("saprc_enh_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : saprc_enh_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("saprc_enh_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: saprc_enh_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("saprc_enh.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : saprc_enh.m");
    exit(1);
  }

  fprintf(fpMatlab, "load saprc_enh.dat;\n");
  fprintf(fpMatlab, "%sc = saprc_enh;\n", prefix);
  fprintf(fpMatlab, "clear saprc_enh;\n");
