...
int InitSaveData()
{
  fpDat = fopen("chapman_mp.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : chapman_mp.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("chapman_mp_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : chapman_mp_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("chapman_mp_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: chapman_mp_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("chapman_mp.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : chapman_mp.m");
    exit(1);
  }

  fprintf(fpMatlab, "load chapman_mp.dat;\n");
  fprintf(fpMatlab, "%sc = chapman_mp;\n", prefix);
  fprintf(fpMatlab, "clear chapman_mp;\n");
