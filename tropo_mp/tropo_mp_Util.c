...
int InitSaveData()
{
  fpDat = fopen("tropo_mp.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : tropo_mp.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("tropo_mp_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : tropo_mp_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("tropo_mp_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: tropo_mp_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("tropo_mp.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : tropo_mp.m");
    exit(1);
  }

  fprintf(fpMatlab, "load tropo_mp.dat;\n");
  fprintf(fpMatlab, "%sc = tropo_mp;\n", prefix);
  fprintf(fpMatlab, "clear tropo_mp;\n");
