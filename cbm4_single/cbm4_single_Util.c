...
int InitSaveData()
{
  fpDat = fopen("cbm4_single.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : cbm4_single.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("cbm4_single_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : cbm4_single_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("cbm4_single_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: cbm4_single_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("cbm4_single.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : cbm4_single.m");
    exit(1);
  }

  fprintf(fpMatlab, "load cbm4_single.dat;\n");
  fprintf(fpMatlab, "%sc = cbm4_single;\n", prefix);
  fprintf(fpMatlab, "clear cbm4_single;\n");
