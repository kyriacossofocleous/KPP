...
! 
! File                 : chapman_f90_mp_Global.f90
...
MODULE chapman_f90_mp_Global

  USE chapman_f90_mp_Parameters, ONLY: sp, dp, NSPEC, NVAR, NFIX, NREACT
  PUBLIC
  SAVE
...
END MODULE chapman_f90_mp_Global
