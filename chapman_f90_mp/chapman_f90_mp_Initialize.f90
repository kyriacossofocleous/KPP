...
! 
! File                 : chapman_f90_mp_Initialize.f90
...
MODULE chapman_f90_mp_Initialize

  USE chapman_f90_mp_Parameters, ONLY: sp, dp, NVAR, NFIX
  IMPLICIT NONE
...
END MODULE chapman_f90_mp_Initialize
