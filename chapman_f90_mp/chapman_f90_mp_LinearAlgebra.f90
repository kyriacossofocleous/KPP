...
! 
! File                 : chapman_f90_mp_LinearAlgebra.f90
...
MODULE chapman_f90_mp_LinearAlgebra
...
! X - Vector for variables
  ...
  X(2) = X(2)-JVS(4)*X(1)
  X(3) = X(3)-JVS(8)*X(1)-JVS(9)*X(2)
  X(4) = X(4)-JVS(12)*X(1)-JVS(13)*X(2)-JVS(14)*X(3)
  X(4) = X(4)/JVS(15)
  X(3) = (X(3)-JVS(11)*X(4))/(JVS(10))
  X(2) = (X(2)-JVS(6)*X(3)-JVS(7)*X(4))/(JVS(5))
...
! XX - Vector for output variables
  ...
  XX(1) = X(1)/JVS(1)
  XX(2) = (X(2)-JVS(2)*XX(1))/(JVS(5))
  XX(3) = (X(3)-JVS(6)*XX(2))/(JVS(10))
  XX(4) = (X(4)-JVS(3)*XX(1)-JVS(7)*XX(2)-JVS(11)*XX(3))/(JVS(15))
  XX(4) = XX(4)
  XX(3) = XX(3)-JVS(14)*XX(4)
  XX(2) = XX(2)-JVS(9)*XX(3)-JVS(13)*XX(4)
  XX(1) = XX(1)-JVS(4)*XX(2)-JVS(8)*XX(3)-JVS(12)*XX(4)
...
END MODULE chapman_f90_mp_LinearAlgebra
