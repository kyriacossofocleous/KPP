...
! 
! File                 : chapman_f90_mp_Integrator.f90
...
MODULE chapman_f90_mp_Integrator

  USE chapman_f90_mp_Parameters, ONLY: NVAR, NFIX, NSPEC, LU_NONZERO
...
SUBROUTINE INTEGRATE( TIN, TOUT, &
  ICNTRL_U, RCNTRL_U, ISTATUS_U, RSTATUS_U, IERR_U )
   ...
   REAL(kind=sp), INTENT(IN) :: TIN  ! Start Time
   REAL(kind=sp), INTENT(IN) :: TOUT ! End Time
   ! Optional input parameters and statistics
   INTEGER,       INTENT(IN),  OPTIONAL :: ICNTRL_U(20)
   REAL(kind=sp), INTENT(IN),  OPTIONAL :: RCNTRL_U(20)
   INTEGER,       INTENT(OUT), OPTIONAL :: ISTATUS_U(20)
   REAL(kind=sp), INTENT(OUT), OPTIONAL :: RSTATUS_U(20)
   INTEGER,       INTENT(OUT), OPTIONAL :: IERR_U

   REAL(kind=sp) :: RCNTRL(20), RSTATUS(20)
...
!~~~>  Local variables
   REAL(kind=sp) :: Roundoff, FacMin, FacMax, FacRej, FacSafe
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE chapman_f90_mp_Parameters, ONLY: NVAR, LU_NONZERO
 USE chapman_f90_mp_Global, ONLY: FIX, RCONST, TIME
 USE chapman_f90_mp_Function, ONLY: Fun
 USE chapman_f90_mp_Rates, ONLY: Update_SUN, Update_RCONST
!~~~> Input variables
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE chapman_f90_mp_Parameters, ONLY: NVAR, LU_NONZERO
 USE chapman_f90_mp_Global, ONLY: FIX, RCONST, TIME
 USE chapman_f90_mp_Jacobian, ONLY: Jac_SP, LU_IROW, LU_ICOL
 USE chapman_f90_mp_LinearAlgebra
 USE chapman_f90_mp_Rates, ONLY: Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=sp) :: T, Y(NVAR)
...
END MODULE chapman_f90_mp_Integrator
