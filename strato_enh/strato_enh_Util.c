...
int InitSaveData()
{
  fpDat = fopen("strato_enh.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : strato_enh.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("strato_enh_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : strato_enh_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("strato_enh_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: strato_enh_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("strato_enh.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : strato_enh.m");
    exit(1);
  }

  fprintf(fpMatlab, "load strato_enh.dat;\n");
  fprintf(fpMatlab, "%sc = strato_enh;\n", prefix);
  fprintf(fpMatlab, "clear strato_enh;\n");
