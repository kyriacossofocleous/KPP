...
double  EP3( double A1, double C1, double A2, double C2, int r) 
      {               
...
/* End INLINED RCONST                                               */
  ...
  RCONST[28] = (EP3(1.30e-13,0.0e0,3.19e-33,0.0e0,28));
  ...
  RCONST[36] = (EP3(2.20e-13,-600.0e0,1.85e-33,-980.0e0,36));
  RCONST[37] = (EP3(3.08e-34,-2800.0e0,2.59e-54,-3180.0e0,37));
  RCONST[38] = ((4.00e-12));
