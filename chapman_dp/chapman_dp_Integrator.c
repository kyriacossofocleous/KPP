...
void FunTemplate2(double, double[], double[]);
...
int Rosenbrock(double Y[], double Tstart, double Tend,
               ...
               void (*ode_Fun2)(double, double[], double[]),
...
void FunTemplate2(double T, double Y[], double Ydot[]);
