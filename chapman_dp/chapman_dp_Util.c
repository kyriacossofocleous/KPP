...
int InitSaveData()
{
  fpDat = fopen("chapman_dp.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : chapman_dp.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("chapman_dp_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : chapman_dp_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("chapman_dp_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: chapman_dp_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("chapman_dp.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : chapman_dp.m");
    exit(1);
  }

  fprintf(fpMatlab, "load chapman_dp.dat;\n");
  fprintf(fpMatlab, "%sc = chapman_dp;\n", prefix);
  fprintf(fpMatlab, "clear chapman_dp;\n");
