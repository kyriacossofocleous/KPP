...
int InitSaveData()
{
  fpDat = fopen("tropo_sp.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : tropo_sp.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("tropo_sp_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : tropo_sp_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("tropo_sp_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: tropo_sp_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("tropo_sp.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : tropo_sp.m");
    exit(1);
  }

  fprintf(fpMatlab, "load tropo_sp.dat;\n");
  fprintf(fpMatlab, "%sc = tropo_sp;\n", prefix);
  fprintf(fpMatlab, "clear tropo_sp;\n");
