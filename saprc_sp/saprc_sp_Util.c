...
int InitSaveData()
{
  fpDat = fopen("saprc_sp.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : saprc_sp.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("saprc_sp_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : saprc_sp_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("saprc_sp_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: saprc_sp_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("saprc_sp.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : saprc_sp.m");
    exit(1);
  }

  fprintf(fpMatlab, "load saprc_sp.dat;\n");
  fprintf(fpMatlab, "%sc = saprc_sp;\n", prefix);
  fprintf(fpMatlab, "clear saprc_sp;\n");
