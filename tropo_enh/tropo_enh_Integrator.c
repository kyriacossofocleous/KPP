...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
   float Ynew[84], Fcn0[84], Fcn[84],
       dFdT[84],
       Jac0[768], Ghimj[768];
   float K[84 * ros_S];
   float H, T, Hnew, HC, HG, Fac, Tau;
   float Err, Yerr[84];
   int Pivot[84], Direction, ioffset, j, istage;
      ...
      *Hexit = H;
      ...
      { /* WHILE STEP NOT ACCEPTED */
         ...
         for (istage = 1; istage <= ros_S; istage++)
         {
            ...
            /* Current istage offset. Current istage vector is K[ioffset:ioffset+84-1] */
            ioffset = 84 * (istage - 1);

            /* For the 1st istage the function has been computed previously */
            if (istage == 1)
               WCOPY(84, Fcn0, 1, Fcn, 1);
            else
            { /* istage>1 and a new function evaluation is needed at current istage */
               if (ros_NewF[istage - 1])
               {
                  ...
                  for (j = 1; j <= istage - 1; j++)
                     WAXPY(84, ros_A[(istage - 1) * (istage - 2) / 2 + j - 1],
                           &K[84 * (j - 1)], 1, Ynew, 1);
         ...
         WCOPY(84, Y, 1, Ynew, 1);
         for (j = 1; j <= ros_S; j++)
            WAXPY(84, ros_M[j - 1], &K[84 * (j - 1)], 1, Ynew, 1);

         /*~~~>  Compute the error estimation   */
         WSCAL(84, ZERO, Yerr, 1);
         for (j = 1; j <= ros_S; j++)
            WAXPY(84, ros_E[j - 1], &K[84 * (j - 1)], 1, Yerr, 1);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
   ...
   WAXPY(84, (-ONE), Fcn0, 1, dFdT, 1);
   WSCAL(84, (ONE / (float)Delta), dFdT, 1);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
   ...
   { /* while Singular */
      ...
      WCOPY(768, Jac0, 1, Ghimj, 1);
      WSCAL(768, (-ONE), Ghimj, 1);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
   ...
   /*~~~> Note: for a full matrix use Lapack:
      NRHS = 1
      DGETRS( 'N', 84 , NRHS, A, 84, Pivot, b, 84, INFO ) */
