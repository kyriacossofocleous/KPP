...
int InitSaveData()
{
  fpDat = fopen("tropo_enh.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : tropo_enh.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("tropo_enh_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : tropo_enh_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("tropo_enh_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: tropo_enh_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("tropo_enh.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : tropo_enh.m");
    exit(1);
  }

  fprintf(fpMatlab, "load tropo_enh.dat;\n");
  fprintf(fpMatlab, "%sc = tropo_enh;\n", prefix);
  fprintf(fpMatlab, "clear tropo_enh;\n");
