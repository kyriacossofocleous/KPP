...
int InitSaveData()
{
  fpDat = fopen("cbm4_mp.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : cbm4_mp.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveError()
{
  fpErr = fopen("cbm4_mp_Err.dat", "w");
  if( fpErr == 0 ) {
    printf("\n Can't create file : cbm4_mp_Err.dat");
    exit(1);
  }
  return 0;
}
...
int InitSaveE()
{
  fpE = fopen("cbm4_mp_E.dat","w");
  if ( fpE == 0 ){
    printf("\n Can't create file: cbm4_mp_E.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("cbm4_mp.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : cbm4_mp.m");
    exit(1);
  }

  fprintf(fpMatlab, "load cbm4_mp.dat;\n");
  fprintf(fpMatlab, "%sc = cbm4_mp;\n", prefix);
  fprintf(fpMatlab, "clear cbm4_mp;\n");
